...
-   **SIMD**: I learned how SIMD can greatly impact performance and how to use it with intrinsics. I did a small [solar system simulation project](https://codeberg.org/St0wy/FunWithVectors) that I then optimized with SIMD to see its impact.
...
You can see the source code of the project on [Codeberg](https://codeberg.org/St0wy/raytracing).
